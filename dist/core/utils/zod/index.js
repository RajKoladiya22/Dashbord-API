...
exports.updateCustomerSchema = zod_1.z.object({
    ...
    specialization: zod_1.z.string().nullable().optional(),
});
...
exports.specializationSchema = zod_1.z.object({
    specialization: zod_1.z.string({ required_error: "Specialization is Required" }).min(1),
});
exports.updateSpecializationSchema = zod_1.z.object({
    newCategoryId: zod_1.z.string().uuid().nullable().optional(),
    oldSpecialization: zod_1.z.string({ required_error: "Specialization is Required" }).min(1),
    newSpecialization: zod_1.z.string({ required_error: "Specialization is Required" }).min(1),
});
